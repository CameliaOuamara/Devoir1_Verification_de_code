...
plt.savefig("Norme_des_erreurs_Schema_1_MMS_Spatial.png", dpi=700)
plt.show()
...
plt.savefig("Norme_des_erreurs_Schema_2_MMS_Spatial.png", dpi=700)
plt.show()
...
plt.savefig("Norme_des_erreurs_Schema_1_MMS_Temp.png", dpi=700)
plt.show()
...
plt.grid()
plt.title("Normes des erreurs L1, L2 et $L_\infty$ avec schéma d'ordre 2 en \n fonction de $\Delta$t avec méthode MMS")
plt.savefig("Norme_des_erreurs_Schema_2_MMS_Temp.png", dpi=700)
plt.show()